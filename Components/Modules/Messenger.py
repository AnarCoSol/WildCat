...
class Messenger():
        def __init__(self, data_path = os.path.dirname(Messenger.__file__) + "/Data"):
                self.silent = False
                self.username = str()
                self.password = str()
                self.mail_to = str()
                ...
                self.input_path = os.path.dirname(data_path) + "/input_path.txt"
                self.head_status = os.path.dirname(data_path) + "/head_status.txt"
                #----------------------Message class---------------------------------
                class Message():
                        ...
                        def fetch_infos(self):
                                ...
                                #format the message for simple and unitary reading string
